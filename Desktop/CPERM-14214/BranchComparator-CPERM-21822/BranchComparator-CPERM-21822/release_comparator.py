...
class ReleaseComparison:
    ...
    def get_change_ids(self, project, tag_version, cpoint_commit_id_1, cpoint_commit_id_2, first_iter, to_append):
        ...
        if "|" in project:
            ...
            #log_api_template = '/plugins/gitiles/%s/+log/%s' % (project_name, tag_version)
            ...
            while True:
                ...
                for log in logs_spec_file['log']:
                    ...
                    while start != -1:
                        ...
                        #print("#########")
                        #print(log['message'][start + 11: end])
    ...
    def compare_changes(self, project):
        ...
        print("souerce_commit_list"+str(self.source_commit_list[project]))
        change_data_1=[]
